...
// ✅ Your OpenWeatherMap API key (from .env or Render env)
const API_KEY = process.env.OPENWEATHER_API_KEY;
const BASE_URL = "https://api.openweathermap.org/data/2.5";
const GEO_URL = "https://api.openweathermap.org/geo/1.0";

// ✅ Village hardcoded coordinates (Amarbiga, Gaya, Bihar)
...
app.get("/api/weather", async (req, res) => {
  try {
    ...
    // Override with the requested city name (cleaner display)
else {
...
// ✅ Preflight (Express v5 compatible)
app.options(/.*/, (req, res) => {
